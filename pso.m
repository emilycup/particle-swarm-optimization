# ========== PARTICAL SWARM OPTIMIZATION SIMULATION - SOMBRERO =============================
# 
# 	EXAMPLE: 	maximize 	r =  sqrt(xx .^2 + yy .^2) + eps;
#							tz = sin(r) ./ r;
#		
...
function graphPSO(x, y, z, i)
		...
		title("Maximize Sombrero Function");
		xlabel("X");
		ylabel("Y");
		zlabel("Z");

		#rotate graph according to current degree
		view(50, 30 + 15 * sin(50/60));

		plotname = ['Sombrero', num2str(i), '.png'];
		print(plotname, '-dpng');
...
#  
# `Will plot the initial scatter plot on mesh graph for the first iteration
...
for i = 1:iteration
	...
	# clear graph for next image of updated points
